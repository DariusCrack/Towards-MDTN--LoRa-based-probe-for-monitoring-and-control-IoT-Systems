...
def run():
	...
	# node_nickname = "T"
	node_nickname = "G" # now the name of the Gateway that acts as a Source
	node_mac_address = "da586520" # Replace with the MAC address of the node you want to connect to
	#node_mac_address = "da5a0e58" # Replace with the MAC address of the node you want to connect to
	#node_mac_address = "00000000"
